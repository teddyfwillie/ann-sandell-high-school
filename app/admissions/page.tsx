...
import { Calendar, CheckCircle, Clock, DollarSign, Phone, Mail, MapPin, ChevronRight } from "lucide-react"
...
export default function Admissions() {
  ...
  const admissionSteps = [
    ...
    },
    {
      ...
      description: "Submit transcripts, test scores, and letters of recommendation",
      timeline: "1-2 weeks",
    },
    {
      step: "03",
  ...
  const tuitionInfo = [
    {
      ...
      includes: ["All core academic courses", "Laboratory fees", "Technology access", "Library services"],
    },
    {
      category: "Additional Costs",
      amount: "$2,500",
      description: "Estimated additional annual expenses",
      includes: ["Textbooks and supplies", "Uniforms", "Field trips", "Activity fees"],
    },
    {
      category: "Financial Aid",
      amount: "Up to 75%",
      description: "Merit and need-based assistance available",
      includes: ["Academic scholarships", "Need-based grants", "Payment plans", "Work-study programs"],
    },
  ]
  ...
  const importantDates = [
    {
      ...
      description: "Online application becomes available for next academic year",
    },
    {
      date: "January 15",
  ...
  return (
    <div className="pt-16">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Join our community of academic excellence and discover your potential
            </p>
            <Link
              href="/apply"
              className="bg-amber-500 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-amber-600 transition-colors inline-flex items-center"
            >
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Admission Statistics</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg text-center">
              <div className="text-3xl font-bold text-blue-800 mb-2">{stats.acceptanceRate}%</div>
              <div className="text-gray-600">Acceptance Rate</div>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg text-center">
              <div className="text-3xl font-bold text-blue-800 mb-2">{stats.averageGPA}</div>
              <div className="text-gray-600">Average GPA</div>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg text-center">
              <div className="text-3xl font-bold text-blue-800 mb-2">{stats.classSize}</div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">Four simple steps to join our academic community</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {requirements.map((req, index) => (
              <div key={index} className="bg-white p-8 rounded-xl shadow-lg">
                <h3 className="text-xl font-semibold text-gray-900 mb-6">{req.category}</h3>
            ...
            {tuitionInfo.map((info, index) => (
              <div key={index} className="bg-white p-8 rounded-xl shadow-lg border-l-4 border-blue-800">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900">{info.category}</h3>
                </div>
                <div className="text-3xl font-bold text-blue-800 mb-2">{info.amount}</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            {importantDates.map((date, index) => (
              <div key={index} className="bg-white bg-opacity-10 p-6 rounded-xl backdrop-blur flex items-center">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Get answers to common questions about our admission process</p>
          </div>
          <div className="space-y-6">
            {faqs.map((faq, index) => (
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Contact Admissions</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Have questions? Our admissions team is here to help guide you through the process
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg text-center">
              ...
              <a href="tel:555-123-4567" className="text-blue-800 font-semibold hover:underline">
                (555) 123-4567
              </a>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg text-center">
              ...
              <a href="mailto:admissions@annsandellhs.edu" className="text-blue-800 font-semibold hover:underline">
